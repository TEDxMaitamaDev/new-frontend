    ...
    <Layout>
        ...
        <Container>
          ...
          >
            <div className="inline-flex items-center gap-2 mb-4">
              <Award className="w-8 h-8 text-tedx-red" />
          ...
          >
            <div className="bg-gray-50 rounded-2xl p-8 md:p-12 border-2 border-tedx-red/20 hover:border-tedx-red/40 transition-all duration-300">
              <div className="relative w-full h-48 md:h-64 flex items-center justify-center mb-6">
                <Image
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-center text-tedx-black">
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <Container>
          ...
          >
            <div className="inline-flex items-center gap-2 mb-4">
              <Users className="w-8 h-8 text-tedx-red" />
              <h2 className="text-3xl md:text-4xl font-bold">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {supportingPartners.map((partner, index) => (
              ...
              >
                <div className="relative w-full h-32 md:h-40 flex items-center justify-center mb-4">
                  <Image
                ...
                <h4 className="text-center text-sm md:text-base font-semibold text-gray-800">
                  {partner.name}
                </h4>
              </motion.div>
            ))}
