      ...
      <Container className="relative z-1 text-white">
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">
            About <span className="text-tedx-red">TEDxMaitama</span>
          </h1>
          <p className="text-xl sm:text-2xl md:text-3xl max-w-3xl mx-auto mb-6 leading-relaxed">
            Amplifying bold ideas and inspiring change across Nigeria and beyond
          </p>
        </motion.div>
      </Container>
    </section>
