...
import { mainNavigation, ticketsNavigation } from "@/lib/navigation"
        ...
        {isOpen && (
          <>
            ...
            >
              ...
              {/* Tickets Button Footer */}
              <div className="border-t border-gray-200 bg-white p-4 flex-shrink-0">
                <Link
                  href={ticketsNavigation.href}
                  onClick={closeMenu}
                  className="block w-full rounded-full bg-red-600 px-6 py-3 text-center text-sm font-semibold text-white transition-colors hover:bg-red-700"
                >
